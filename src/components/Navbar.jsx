...
function Navbar() {
    ...
    return (
        <div className='bg-opacity-20 shadow-sm'>
            <nav className='flex items-center justify-between p-5 container m-auto'>
                <div className='text-xl font-bold text-blue-600'>Market App</div>
                <div className='flex gap-5 items-center text-zinc-600 text-lg'>
                    <Link to="/">Home</Link>
